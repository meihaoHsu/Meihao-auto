...
/* nav-menus-full.twig */
class __TwigTemplate_1e31ec23ba253b826393d981045283a9c796b669670e42c571f1d8400e5da557 extends \WPML\Core\Twig\Template
{
    ...
    ";
        ...
        if (($context["can_operate_options"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["key"] => $context["taxonomy"]) {
                ...
                if ($this->getAttribute($context["taxonomy"], "is_translatable", [])) {
                    ...
                    ";
                    // line 8
                    if ($this->getAttribute($context["taxonomy"], "warning", [])) {
            ...
            if ($this->getAttribute($this->getAttribute(($context["menu"] ?? null), "custom_taxonomies", []), "show", [])) {
                ...
                ";
                // line 15
                if ($this->getAttribute($this->getAttribute(($context["menu"] ?? null), "custom_taxonomies", []), "warning", [])) {
                    echo "<i class=\"otgs-ico-warning\"></i>";
                }
                // line 16
                echo "            </a>
        ";
            ...
            ";
            // line 20
            if ($this->getAttribute($this->getAttribute(($context["menu"] ?? null), "attributes", []), "warning", [])) {
                echo "<i class=\"otgs-ico-warning\"></i>";
            }
            // line 21
            echo "        </a>
        ";
            ...
            if ($this->getAttribute($this->getAttribute(($context["menu"] ?? null), "shipping_classes", []), "is_translatable", [])) {
               ...
               title=\"";
                ...
                ";
                // line 25
                if ($this->getAttribute($this->getAttribute(($context["menu"] ?? null), "shipping_classes", []), "warning", [])) {
                    echo "<i class=\"otgs-ico-warning\"></i>";
                }
                // line 26
                echo "            </a>
    ...
    {% endif %}
</nav>", "nav-menus-full.twig", "/var/www/bike.meihao.shopping/htdocs/wp-content/plugins/woocommerce-multilingual/templates/nav-menus-full.twig");
    }
}
