...
if (!class_exists("CategoryAjaxFilterProBase")) {
    class CategoryAjaxFilterProBase
    {
        public $key = "ABC029C977E41A2C";
        private $product_id = "3";
        private $product_base = "caf-pro";
        private $server_host = "https://license.trustyplugins.com/wp-json/licensor/";
        ...
        {
            $plugin_base_file = TC_CAF_PRO_PATH . '/caf-pro.php';
            ...
            if ($this->hasCheckUpdate) {
                if (function_exists("add_action")) {
                    add_action('admin_post_caf-pro_fupc', function () {
                    ...
                    if ($this->isTheme) {
                        ...
                        add_filter('plugin_row_meta', function ($links, $plugin_file) {
                            if ($plugin_file == plugin_basename($this->pluginFile)) {
                                $links[] = " <a class='edit coption' href='" . esc_url(admin_url('admin-post.php') . '?action=caf-pro_fupc') . "'>Update Check</a>";
                            }
                            return $links;
                        }, 10, 2);
